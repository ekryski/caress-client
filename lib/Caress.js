  ...
  define(function(require, exports, module) {
    ...
    Client.prototype.processCursorAlive = function(packet, message){
      ...
      for (var i = 0; i < notActiveCursors.length; i++){
        ...
        // TODO: This should probably be moved to a spot where we are sure the
        // touch has been created in order to make sure the touch is in the
        // touchesChanged array for the event
